...
ARG FEX_VER=FEX-2505

ARG DEBIAN_FRONTEND=noninteractive

# --------------------------------------------------------------------------------

FROM debian:bookworm AS fex-builder-amd64

FROM --platform=arm64 debian:bookworm AS fex-builder-arm64
...
FROM debian:bookworm AS fex-rootfs-amd64

FROM --platform=arm64 debian:bookworm AS fex-rootfs-arm64
...
FROM debian:bookworm AS fx-downloader
...
# --------------------------------------------------------------------------------
FROM debian:bookworm AS base-amd64

FROM --platform=arm64 debian:bookworm AS base-arm64
